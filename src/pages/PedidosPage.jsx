...
export const PedidosPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success(`Pedido #${res.data.id} registrado exitosamente`);
      ...
      const detail = Array.isArray(msg)
        ...
        : (typeof msg === 'string' ? msg : 'Error al registrar el pedido');
      toast.error(detail);
    } finally {
      setSubmitting(false);
    }
    ...
    <div>
      <div className="page-header">
        <div className="page-header-left">
          <div className="page-title">Carga de Pedido</div>
          ...
          <>
            ...
            <div className="card-footer" style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ fontSize: 16, fontWeight: 700, color: 'var(--gray-900)' }}>
                Total estimado: {fmt(totalPedido)}
              </span>
            </div>
          </>
        )}
